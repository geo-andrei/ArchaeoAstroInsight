...
from arche_detection_dialog import ArcheDetectionDialog

from utilities import get_qgis_app
QGIS_APP = get_qgis_app()


class ArcheDetectionDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = ArcheDetectionDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(ArcheDetectionDialogTest)
