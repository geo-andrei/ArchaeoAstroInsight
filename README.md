...
*The dialog on first open. Notice that the **Azimuth estimation**, **Astronomical declination computation**, and **curvigram** sections are greyed out; they stay disabled until you tick **Export object detection crops** and choose an output folder.*
...
- **Detection Confidence:** minimum score (0-1, default **0.50**) for a detection to be kept; higher means fewer, more confident detections.
